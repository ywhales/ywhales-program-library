...
mod mint_new_edition_from_master_edition_via_vault_proxy {
    ...
    async fn success() {
        ...
        program_test.add_program("ywpl_token_vault", ywpl_token_vault::id(), None);
    ...
    async fn fail_invalid_vault_authority() {
        ...
        assert_custom_error!(
            result,
            ywpl_token_vault::error::VaultError::AuthorityDoesNotMatch
        );
    }
    ...
    async fn fail_store_account_mismatch() {
        ...
        let metaplex_token_vault_id = ywpl_token_vault::id();
        ...
        assert_custom_error!(
            result,
            ywpl_token_vault::error::VaultError::StoreDoesNotMatchSafetyDepositBox
        );
    }
}
